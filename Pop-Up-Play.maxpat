...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.189575, 124.0, 133.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.189575, 290.5, 131.0, 32.0 ],
					"text" : ";\r\nmax launchbrowser $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.189575, 233.0, 206.0, 46.0 ],
					"text" : "\"file://C:/Users/user/Documents/PUP/Manuals/PUP User Manual V1.5.pdf\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.689575, 30.0, 117.0, 46.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 30.0, 130.0, 46.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 472.689575, 170.5, 43.0, 20.0 ],
					"text" : "s path"
				}
...
, 			{
				"box" : 				{
					...
					"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "nogrow", "close", "nozoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 50, 50, 32768, 32768, ";", "#Q", "window", "size", 17, 61, 631, 717, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ],
					"text" : "thispatcher"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-7::obj-13" : [ "umenu[14]", "umenu[8]", 0 ],
			...
			"obj-3::obj-2::obj-56" : [ "toggle[44]", "toggle", 0 ],
			...
			"obj-2::obj-87" : [ "umenu[25]", "umenu[5]", 0 ],
			...
			"obj-1::obj-136" : [ "toggle[31]", "toggle[8]", 0 ],
			"obj-2::obj-7::obj-6" : [ "toggle[20]", "toggle", 0 ],
			...
			"obj-3::obj-11::obj-17" : [ "umenu[37]", "umenu[13]", 0 ],
			...
			"obj-3::obj-13::obj-17" : [ "umenu[40]", "umenu[13]", 0 ],
			...
			"obj-3::obj-5::obj-50" : [ "umenu[47]", "umenu[13]", 0 ],
			"obj-5::obj-69::obj-64" : [ "number[9]", "number[2]", 0 ],
			"obj-2::obj-58" : [ "toggle[39]", "toggle", 0 ],
			...
			"obj-4::obj-2" : [ "toggle[64]", "toggle", 0 ],
			...
			"obj-3::obj-5::obj-18" : [ "umenu[49]", "umenu[13]", 0 ],
